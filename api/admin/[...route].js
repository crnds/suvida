...
import { listTemplate, addTemplateEntry, editTemplateEntry, removeTemplateEntry } from '../_routes/admin/template.js';
import { listLocations, addLocation, editLocation, removeLocation } from '../_routes/admin/locations.js';
...
router.add('PATCH', '/template/:id', editTemplateEntry);
...
router.add('PATCH', '/locations/:id', editLocation);
